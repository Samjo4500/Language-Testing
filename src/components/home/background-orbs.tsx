export function BackgroundOrbs() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      <div className="orb orb-blue w-[700px] h-[700px] -top-48 -left-48 animate-float-slow" />
      <div className="orb orb-cyan w-[500px] h-[500px] top-1/4 -right-24 animate-float-reverse" />
      ...
      <div className="absolute top-[15%] left-[55%] w-1 h-1 rounded-full bg-blue-300/60 animate-float" style={{ animationDelay: '0.5s' }} />
      <div className="absolute top-[30%] right-[25%] w-1.5 h-1.5 rounded-full bg-cyan-300/40 animate-float-reverse" style={{ animationDelay: '1.5s' }} />
