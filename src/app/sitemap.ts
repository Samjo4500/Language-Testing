...
export default function sitemap(): MetadataRoute.Sitemap {
  const baseUrl = 'https://www.testcefr.com';
  return [
    ...
    { url: `${baseUrl}/quick-tour`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/sample-certificate`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/sample-report`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
