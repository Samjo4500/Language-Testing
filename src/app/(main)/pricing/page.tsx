        ...
        <div className="container mx-auto px-4">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div className="flex flex-col">
                  <span className="text-white font-bold text-base">CEFRTest</span>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-white/40">Secure payments powered by PayPal</span>
            </div>

            <p className="text-xs text-white/30">&copy; {new Date().getFullYear()} CEFR Test. All rights reserved.</p>

            <div className="flex items-center gap-4">
              <Link href="/privacy" className="text-xs text-white/30 hover:text-white/50 transition-colors">Privacy Policy</Link>
              <Link href="/terms" className="text-xs text-white/30 hover:text-white/50 transition-colors">Terms of Service</Link>
              <Link href="/about" className="text-xs text-white/30 hover:text-white/50 transition-colors">About</Link>
              <Link href="/verify" className="text-xs text-white/30 hover:text-white/50 transition-colors">Verify Certificate</Link>
            </div>
          </div>
        </div>
      </footer>
