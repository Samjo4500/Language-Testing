...
const ENGLISH_LEVELS = [
  ...
  { value: 'C1', label: 'C1 — Advanced', color: 'bg-indigo-500/20 text-indigo-400 border-indigo-500/30', desc: 'Complex texts & nuanced expression' },
  { value: 'C2', label: 'C2 — Proficient', color: 'bg-blue-500/20 text-blue-400 border-blue-500/30', desc: 'Near-native mastery' },
];
